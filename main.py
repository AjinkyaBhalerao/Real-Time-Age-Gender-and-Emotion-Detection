...
# load the model
sex_model = pickle.load(open('C:\\Users\\AKSHITA RAI\\Downloads\\sex-model-final.pkl', 'rb'))
age_model = pickle.load(open('C:\\Users\\AKSHITA RAI\\Downloads\\age-model-final.pkl', 'rb'))
emotion_model = pickle.load(open('C:\\Users\\AKSHITA RAI\\Downloads\\emotion-model-final.pkl', 'rb'))
